...
const TradingPanel = () => {
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      <div style={{ padding: '10px 12px 8px', flexShrink: 0, borderBottom: `1px solid ${BORDER}`, background: '#fff' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10 }}>
          <div>
            <div style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.10em', color: '#aaa' }}>Trading Dashboard</div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', minHeight: 0, padding: 12, background: '#F8F7F5' }}>
        <div style={{ maxWidth: 560, margin: '0 auto', display: 'grid', gap: 12 }}>
          ...
          <div style={{ background: '#fff', border: `1px solid ${BORDER}`, borderRadius: 14, padding: 14, boxShadow: '0 2px 10px rgba(0,0,0,0.04)' }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#888', marginBottom: 10 }}>Market Summary</div>
            <div style={{ display: 'grid', gap: 8 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12 }}><span>NIFTY</span><strong>Live</strong></div>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12 }}><span>Watchlist</span><strong>Synced</strong></div>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12 }}><span>Alerts</span><strong>Enabled</strong></div>
            </div>
          </div>
        </div>
      </div>
