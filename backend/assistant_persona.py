...
ASSISTANT_PERSONA = (
    ...
    "- AUTOMATIC DETECTION: Always respond in the SAME language the user addresses you in. If they speak Telugu, answer in Telugu. If they speak English, answer in English.\n"
    "- TRANSLATION: If asked to translate, provide accurate and contextual translations between English and Telugu.\n\n"
    "CRITICAL RULES:\n"
